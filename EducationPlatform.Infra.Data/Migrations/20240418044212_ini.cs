    ...
    public partial class ini : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.treinaweb.com.br%2Fblog%2Fcomo-instalar-o-csharp-e-nosso-primeiro-exemplo&psig=AOvVaw1j2JR7fNFScafseX_uX4qA&ust=1713292306049000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCPDhk67txIUDFQAAAAAdAAAAABAE", new DateTime(2024, 4, 18, 1, 42, 12, 440, DateTimeKind.Local).AddTicks(72), "Iniciando pelo básico do C#", "Introdução o C#", 1 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessLevel", "Birthday", "CPF", "Email", "FullName", "IsActive", "Password", "PhoneNumber", "SignatureId" },
                values: new object[,]
                {
                    { 1, 0, new DateTime(1997, 4, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "06445661327", "abi@mail.com", "abi", true, "123456789", "86952258855", 1 },
                    { 2, 1, new DateTime(1985, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "12345678910", "joao@mail.com", "nay", true, "123456789", "987654321", 1 }
                });

            migrationBuilder.InsertData(
                table: "Blocks",
                columns: new[] { "Id", "CreationDate", "Description", "IdCourse", "Name" },
                values: new object[] { 1, new DateTime(2024, 4, 18, 1, 42, 12, 439, DateTimeKind.Local).AddTicks(7505), "Description", 1, "Instalção das ferramentas" });

            migrationBuilder.InsertData(
                table: "Lessons",
                columns: new[] { "Id", "BlockId", "CreationDate", "Description", "Duration", "LinkVideo", "Name" },
                values: new object[] { 1, 1, new DateTime(2024, 4, 18, 1, 42, 12, 440, DateTimeKind.Local).AddTicks(1731), "Descrição", 600, "https://www.youtube.com/watch?v=PZ7HiQdT0Dw", "Visual Studio Code" });
